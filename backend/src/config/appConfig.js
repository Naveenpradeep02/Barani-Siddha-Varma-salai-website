...
module.exports = {
  ...
  INSTAMOJO_ENDPOINT: process.env.INSTAMOJO_ENDPOINT,
  INSTAMOJO_AUTH_ENDPOINT: process.env.INSTAMOJO_AUTH_ENDPOINT,
  INSTAMOJO_API_VERSION: process.env.INSTAMOJO_API_VERSION,
